...
configurable threshold are tagged (by default with ~ai-relevant~),
...
=+ai-relevant= in your elfeed search filter to see only curated
content:
...
([[#h:scoring-behavior][Scoring behavior]]).  The default is ~ai-relevant~.  You can change
